...
from mt import leituraMT, leituraALL #importando classe da implementaçao da maquina de turing (mt) e da maquina de turing com alfabeto arbitrario (all)
...
if __name__ == "__main__":
    ...
    '''
    try:
        with open('nova implementação/fusão/arquivos/' + arquivoEntrada, 'r', encoding='utf-8') as arquivo:
    ...
    # tratando o erro caso não consiga abrir o arquivo de entrada
        ...
        print(f"\nErro: arquivo '{entrada}' não encontrado.")
        exit()
